...
class UploadComponent extends React.Component {
    ...
    onSuccess = (uploadData) => {
        const p = this.props;
        if (!uploadData) 
            p.field.onChange(null);
        else
            p.field.onChange(uploadData.repositoryPath);
    ...
    render() {
        ...
        return (
            <div className='FormField'>
                ...
                {this.props.hint ? <small className='Hint'><Loc>{this.props.hint}</Loc></small> : null}
                    ...
                    >
                        {field.value ?
                            ...
                            <div className='NoImage'>
                                <h3><Loc>Upload.Image</Loc></h3>
                                <p>&nbsp;</p>
                                <p className='Button Active'><Loc>UploadButton</Loc></p>
                            </div>
                        }
                    </Upload>
                    <div className='Remove'>
                        <p><Loc>Upload.DropImage</Loc></p>
                        {/* <p><Loc>Upload.Remove</Loc></p> */}
                        <p className='Button' onClick={(data) => this.onSuccess(null)}><Loc>Upload.RemoveButton</Loc></p>
                    </div>
                </div>
