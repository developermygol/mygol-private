    ...
    return (
      <React.Fragment>
        <Switch>
          ...
          <Route
            path={path + '/new'}
            render={props => <EditComponent {...addProps} {...passProps} isEditing={false} />}
          />
          <Route
            path={path + '/edit/:' + idParamName}
            render={props => <EditComponent {...editProps} {...passProps} isEditing={true} />}
          />
          <Route
            path={path + '/:' + idParamName}
            render={props => <DetailsComponent {...detailsProps} {...passProps} />}
          />
        </Switch>
      </React.Fragment>
    );
