    ...
    getField = (f) => {
        ...
        switch (f.editRenderType) {
            ...
            case 'upload':
                ...
                args.passProps = { idObject: this.getValue(idFieldName), ...f.passProps, isEditing: this.isEditing(), onUploadSuccess: (ud) => { 
        ...
        return (
            <control.target key={f.fieldName} field={formField} {...args} />
        )
    }
                    ...
                    <Spinner loading={!this.ready}>
                        {this.ready ?
                            <div className='Content'>
                                ...
                                <form>
                                    {this.getGroups(this.getFields())}
                                </form>
                                
                                <div className='Errors'>
                                    {this.errorSummary.map(e => <p key={e} className='Error'>{e}</p>)}
                                </div>

                                <div className='EditButtons'>
                                    {p.backButton ? <BackButton onClick={p.onBackClick} /> : null}
                                    <SpinnerButton loading={p.loading} className='Button Active' onClick={form.onSubmit}><Loc>Save</Loc></SpinnerButton>
                                </div>
                            </div>
                            :
                            <div className='Content'>
                                <InfoBox><Loc>No data to edit</Loc></InfoBox>
                            </div>
                        }
                    </Spinner>
                </div>
