export default {
    ...
    "Player.NoTeams": "Actualmente este jugador no está asociado a ningún equipo",
    ...
    "MatchEventType1": "MatchStarted",
    "MatchEventType10": "FirstHalfFinish",
    "MatchEventType11": "SecondHalfStarted",
    "MatchEventType12": "SecondHalfFinish",
    "MatchEventType13": "MatchEnded",
    "MatchEventType15": "ExtraTimeFirstHalfStart",
    "MatchEventType16": "ExtraTimeFirstHalfEnd",
    "MatchEventType17": "ExtraTimeSecondHalfStart",
    "MatchEventType18": "ExtraTimeSecondHalfEnd ",
    "MatchEventType30": "Assist",
    "MatchEventType31": "Point",
    "MatchEventType32": "PointInOwn",
    "MatchEventType33": "Corner",
    "MatchEventType34": "Fault",
    "MatchEventType40": "Penalty",
    "MatchEventType41": "PenaltyFailed",
    "MatchEventType42": "PenaltyStopped",
    "MatchEventType50": "Injury",
    "MatchEventType61": "Card1",
    "MatchEventType62": "Card2",
    "MatchEventType63": "Card3",
    "MatchEventType64": "Card4",
    "MatchEventType65": "Card5",
    "MatchEventType100": "RecordClosed",

    "FieldPosition0": "Not Set",
    ...
    "Rests": " rests", 
    "No teams. Need teams": "No teams inscribed in the competition",
    ...
    "Team status": "Status",
    "Team goalkeeper": "Starting goalkeeper",
    "Team goalkeeper.hint": "Optional. If this player is selected it will accommodate all the received goals in the statistics and it will appear on the goalkeeper rankings.",
    "Local field": "Local fiels", 
    "Local field.hint": "Optional. If selected it will be used as a preferred field when the team plays at home and it will be used when the calendars are generated.", 
    "Preferred time": "Prefered game time", 
    "Preferred time.hint": "Optional. If selected it will be used as a preferred when the team plays home and it will be used when the calendars are generated.", 

    "Team.ImgUrl1": "Team image", 
    "Team.ImgUrl2": "Team image 2", 
    "Team.ImgUrl3": "Team image 3", 

    "Team.NoPlayers": "Team has no players",
    "Team.NoLogo.AddOne": "No logo has been defined yet.",
    "Team.NoTactic.AddOne": "No tactic has been defined yet.",
    "Team.NoApparel.AddOne": "No equipementhas been defined yet.",
