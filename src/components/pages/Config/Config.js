            ...
            <React.Fragment>
                <ul className='TabBar'>
                    <AccessLimit allowOrgAdmin>
                        ...
                        <li className='TabItem'><NavLink to={baseUrl + '/org'}><Loc>Orgdata</Loc></NavLink></li>
                        <li className='TabItem'><NavLink to={baseUrl + '/seasons'}><Loc>Seasons</Loc></NavLink></li>
                        <li className='TabItem'><NavLink to={baseUrl + '/tournamentmodes'}><Loc>Tournament modes</Loc></NavLink></li>
                        {/* <li className='TabItem'><NavLink to={baseUrl + '/cards'}><Loc>Config.Cards</Loc></NavLink></li> */}
                        <li className='TabItem'><NavLink to={baseUrl + '/sponsors'}><Loc>Config.Sponsors</Loc></NavLink></li>
                        {/* <li className='TabItem'><NavLink to={baseUrl + '/import'}><Loc>Config.Import</Loc></NavLink></li> */}
                        <li className='TabItem'><NavLink to={baseUrl + '/notiftemplates'}><Loc>Config.NotificationTemplates</Loc></NavLink></li>
                        <li className='TabItem'><NavLink to={baseUrl + '/users'}><Loc>Config.Users</Loc></NavLink></li>
                        <li className='TabItem'><NavLink to={baseUrl + '/payments'}><Loc>Payments</Loc></NavLink></li>
                        <li className='TabItem'><NavLink to={baseUrl + '/reports'}><Loc>OrgReports</Loc></NavLink></li>
                    </AccessLimit>
