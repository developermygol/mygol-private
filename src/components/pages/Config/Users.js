    ...
    render() {
        ...
        return (
            <CrudForm
                ...
                fieldDefinition={[
                    { fieldName: 'avatarImgUrl', localizedLabel: 'AvatarImg', listRenderHandler: this.getUserAvatar, editRenderType: 'upload', hideInAdd: true, passProps: { idField: 'id', uploadType: 200 } },
                    ...
                    { fieldName: 'level', hideInList: true, hideInAdd: true, hideInEdit: true, localizedLabel: 'Level', editRenderType: 'select', selectOptions: getSelectOptionsFromFixedValues('UserLevel', 4, 4) },
                    { fieldName: 'lang', localizedLabel: 'Language', editRenderType: 'text' },
                    { fieldName: 'password', localizedLabel: 'Password', hint: 'Password.Hint', editRenderType: 'text', hideInList: true },
                ]}
            />
        )
    }
