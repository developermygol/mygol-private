...
class PlayerDetails extends Component {
    ...
    componentDidMount = () => {
        ...
        requestAsync(this, axios.get, null, uri)
            ...
            <Spinner loading={this.loading}>
                {player ?
                    <Fragment>
                        ...
                        <ul className='TabBar'>
                            <li className='TabItem'><NavLink to={baseUrl} exact><Loc>Player.Data</Loc></NavLink></li>
                            <AccessLimit allowOrgAdmin>
                                <li className='TabItem'><NavLink to={baseUrl + '/events'}><Loc>Player.Events</Loc></NavLink></li>
                                <li className='TabItem'><NavLink to={baseUrl + '/teams'}><Loc>Player Teams</Loc></NavLink></li>
                                <li className='TabItem'><NavLink to={baseUrl + '/sanctions'}><Loc>Player.Sanctions</Loc></NavLink></li>
                                {idTeam ? <li className='TabItem'><NavLink to={baseUrl + '/payments'}><Loc>Player.Payments</Loc></NavLink></li> : null }
                            </AccessLimit>
                        </ul>
                        ...
                        <div className='TabContent'>
                            <Switch>
                                ...
                                <Route path={basePath + '/sanctions'} render={() => <PlayerSanctions sanctions={player.sanctions} />} />
