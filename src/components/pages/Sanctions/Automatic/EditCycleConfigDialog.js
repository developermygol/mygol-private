...
const fields = [
    { fieldName: 'name', localizedLabel: 'Sanctions.Cycles.Name', editRenderType: 'text', rules: 'required|string' },
    { fieldName: 'numYellowCards', localizedLabel: 'Sanctions.Cycles.NumYellowCards', hint: 'Sanctions.Cycles.NumYellowCards.Hint', editRenderType: 'text', rules: 'integer' },
