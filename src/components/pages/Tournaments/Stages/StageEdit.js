...
class StageEdit extends Component {
  ...
  otherFields = [
    {
      fieldName: 'type',
      localizedLabel: 'Stage.Type',
      hint: '',
      editRenderType: 'radio',
      selectOptions: getSelectOptionsFromFixedValues('StageType', 1, 2),
  ...
  leagueFields = [
    {
      fieldName: 'classificationCriteria',
      localizedLabel: 'Stage.ClassificationCriteria',
      hint: '',
      editRenderType: 'classificationCriteria',
    },
    {
      fieldName: 'colorConfig',
      localizedLabel: 'Stage.ColorConfig',
      hint: 'Stage.ColorConfig.Hint',
      editRenderType: 'colorclassificationconfig',
    },
  ];
