...
export default class Apparel extends Component {
    ...
    render() {
        ...
        if (!team) return <InfoBox><Loc>No team</Loc></InfoBox>
        ...
        return (
            <div className='EditorContent'>
                ...
                <div className=''>
                    {/* <BackButton /> */}
                    <button disabled={!this.canSave} className={'Button ' + (this.canSave ? 'Active' : 'Disabled')} onClick={this.saveButtonHandler}><Loc>Save</Loc></button>
                </div>
            </div>
        )
