...
class TopLevelTactic extends Component {
    render() {
        ...
        return (
            <Fragment>
                <h2><Loc>Tactics</Loc></h2>
                <div className=''>
                    <ul className='TabBar'>
                        <li className='TabItem'><NavLink to={baseUrl + '/select'}><Loc>Tactic.Selection</Loc></NavLink></li>
                        <li className='TabItem'><NavLink to={baseUrl + '/players'}><Loc>Tactic.Players</Loc></NavLink></li>
                    </ul>
