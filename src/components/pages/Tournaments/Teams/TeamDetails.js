      ...
      <React.Fragment>
        <AccessLimit allowOrgAdmin allowTeamAdmin>
          <ul className="TabBar">
            ...
            <li className="TabItem">
              <NavLink to={baseUrl + '/apparel'}>
                <Loc>Apparel</Loc>
              </NavLink>
            </li>
            <li className="TabItem">
              <NavLink to={baseUrl + '/logo'}>
                <Loc>Logo</Loc>
              </NavLink>
            </li>
            <li className="TabItem">
              <NavLink to={baseUrl + '/tactics/select'}>
                <Loc>Tactics</Loc>
              </NavLink>
            </li>
            <li className="TabItem">
              <NavLink to={baseUrl + '/photos'}>
                <Loc>Photos</Loc>
              </NavLink>
            </li>
            <li className="TabItem">
...
class TeamIndex extends Component {
  ...
  exportButtonHandler = () => {
    ...
    this.props.store.teams.getTeamExport(idTeam, idTournament);
  };
  ...
  teamObliteratedHandler = button => {
    ...
    p.store.teams.obliterate(p.store.teams.current).then(res => {
      if (!res) return;
      ...
      <div className="CardContainer">
        <div className="Card W33">
          <h3>
            ...
            <Link className="Edit" to={url + '/logo'}>
              <Loc>Edit</Loc>
            </Link>
          </h3>
        ...
        <div className="Card W33">
          <h3>
            ...
            <Link className="Edit" to={url + '/apparel'}>
              <Loc>Edit</Loc>
            </Link>
          </h3>
          <div className="Content">
        ...
        <div className="Card W33">
          <h3>
            <Link to={url + '/tactics/select'}>
              <Loc>Tactic</Loc>
            </Link>{' '}
            <Link className="Edit" to={url + '/tactics/select'}>
              <Loc>Edit</Loc>
            </Link>
          </h3>
          <div className="Content">
        ...
        <div className="Card Hero">
          <h3>
            ...
            <Link className="Edit" to={url + '/players'}>
              <Loc>See all</Loc>
            </Link>
          </h3>
          <div className="Content">
        ...
        <AccessLimit allowOrgAdmin>
          <div className="Card Hero">
            ...
            <div className="Content">
              ...
              <button className="Button" onClick={this.exportButtonHandler}>
                <Loc>Export team</Loc>
              </button>
              <button className="Button Dangerous" onClick={this.obliterateTeamHandler}>
                <Loc>Team.Obliterate</Loc>
              </button>
            </div>
          </div>
        </AccessLimit>
        ...
        <MessageBox
          show={this.showObliterateConfirmation}
          onClose={this.teamObliteratedHandler}
          buttons="DeleteCancel"
        >
          <p className="ModalHead">
            <Loc>Team.Obliterate.Confirm.Title</Loc>
          </p>
          <p>
            <Loc>Team.Obliterate.Confirm</Loc>
          </p>
        </MessageBox>
      </div>
    );
