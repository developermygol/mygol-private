...
class CompetitionTeams extends Component {
    ...
    getTeamLogo(t) {
        return this.getTeamLink(t, 
            <img alt='' src={getUploadsIcon(t.logoImgUrl, t.id)} className='TeamLogo'/>
        );
    }
    ...
    @action handleTeamAdded = (data) => {
        ...
        store.addTeamToTournament(idTournament, idTeam)
            .then(res => {
            ...
            <div>
                <CrudForm 
                    ...
                    listAdditionalButtons={
                        <button className='Button' onClick={this.handleAddTeam}><Loc>Add existing team</Loc></button>
                    }
                    ...
                    fieldDefinition={[
                        { fieldName: 'logoImgUrl', localizedLabel: 'Logo', listRenderHandler: t => this.getTeamLogo(t) },
                        { fieldName: 'keyName', localizedLabel: 'Short name', listRenderHandler: t => this.getTeamLink(t, t.keyName), editRenderType: 'text', rules: 'required|between:1,4' },
                        { fieldName: 'name', localizedLabel: 'Team name', listRenderHandler: t => this.getTeamLink(t, t.name), editRenderType: 'text', rules: 'required|between:1,100'},
                        { fieldName: 'idField', localizedLabel: 'Local field', hint: 'Local field.hint', editRenderType: 'facilitySelector', rules: 'integer', hideInList: true },
                ...
                <AddTeamDialog
                    show={this.showAddTeamDialog}
                    onClose={this.handleTeamAdded}
                />
            </div>
        )
    }
