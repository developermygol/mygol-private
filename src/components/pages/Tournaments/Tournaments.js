...
import { getSelectOptionsFromTable, getSelectOptionsFromFixedValues } from '../../common/FormsMobx/EditRenderHandlers'
                ...
                <CrudForm 
                    ...
                    fieldDefinition={[
                        ...
                        { 
                            ...
                            selectOptions: [ { value: 'false', label: 'No' }, { value: 'true', label: 'Yes' } ] 
                        }
                    ]}
                />
            </React.Fragment>
